...
class TestAddContact(unittest.TestCase):
    ...
    def create_contact(self, wd, firstname="Firstnameex", middlename="Middlenameex", lastname="Lastnameex",
                       nickname="Nickex", title="Titleex", company="Companyex", address="Addressex",
                       home="1(999)111-11-11", mobile="+79111111111", work="2(999)222-22-22", fax="3(999)333-33-33",
                       email="123@mail.com", email2="456@mail.com", email3="789@mail.com", homepage="Pageex", byear="1990",
